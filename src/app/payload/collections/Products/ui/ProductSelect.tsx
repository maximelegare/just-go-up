...
import { Select, useFormFields } from '@payloadcms/ui'
import { TextField, CopyToClipboard } from '@payloadcms/ui'

export const ProductSelect: React.FC<typeof TextField> = (props) => {
  const { name } = props
